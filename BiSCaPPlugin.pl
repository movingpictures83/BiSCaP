...
my ($tally_HOMSNP, $tally_HOMINS, $tally_HOMDEL, $tally_HETSNP, $tally_HETINS, $tally_HETDEL);
my ($tally_OUTDIS, $tally_HOMAGR, $tally_MINDEP, $tally_UNCHAR, $removed_bases) ;
...
$opt_p = PerlPluMA::prefix."/".$file_data{"mpileup"};
$opt_r = PerlPluMA::prefix."/".$file_data{"reference"};
...
open $ofh, '>', $outfile1 or die "Cannot open $outfile1 : $!\n";
...
($tally_HOMSNP, $tally_HOMINS, $tally_HOMDEL, $tally_HETSNP, $tally_HETINS, $tally_HETDEL) = (0, 0, 0, 0, 0, 0);
($tally_OUTDIS, $tally_HOMAGR, $tally_MINDEP, $tally_UNCHAR, $removed_bases) = (0, 0, 0, 0, 0);
